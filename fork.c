...
#include <nanvix/clock.h>/* Ajouté : nécessaire pour accéder à la variable globale ticks */
...
found:
	...
	proc->cktime = 0;
	/*
	 * Ajouté pour le nouvel ordonnanceur :
	 * mémorise le tick système au moment de la création
	 * afin de calculer l'âge du processus (ticks - creation_ticks).
	 */
	proc->creation_ticks = ticks;
